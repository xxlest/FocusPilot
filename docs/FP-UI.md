...
| 📁 | **AreaProjects** | 项目资产沉淀（执行类+知识类），文件树+Markdown 编辑器+知识管道+KB 卡片+Anki 同步 | **设计中** | [05-area-projects.md](fp-ui/05-area-projects.md) | [00-layout-prototype.html](fp-ui/00-layout-prototype.html) |
