...
| 🤖 | AICrew | Agent 团队管理（成员详情 / Runtime 绑定 / Agent 配置 / MCP 状态 / 常驻职责 / 运行状态） | **可开发** | [07-ai-crew.md](fp-ui/07-ai-crew.md) | [00-layout-prototype.html](fp-ui/00-layout-prototype.html) |
