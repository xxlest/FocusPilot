...
| 💻 | **Studio** | 跨项目 AI 工作台：全局视图（规划/看板/列表）+ 项目视图（工作项/对话/Diff/终端）+ Workspace + ExecutionRun | **可开发** | [04-studio.md](fp-ui/04-studio.md) | [00-layout-prototype.html](fp-ui/00-layout-prototype.html) |
